export default function ChatFAB() {
  return (
    <div className="fixed bottom-[24px] right-[24px] z-50 flex flex-col items-end gap-2 group">
      ...
      {/* Button */}
      <button className="w-16 h-16 bg-[#fea619] text-white rounded-full shadow-[0px_10px_30px_rgba(26,54,93,0.2)] hover:bg-[#855300] hover:scale-105 active:scale-95 transition-all duration-300 flex items-center justify-center relative border-4 border-white">
