    ...
    return (
      <div className="flex gap-4 max-w-[80%]">
        ...
        <div className="space-y-1">
          <div className="bg-white border border-slate-100 p-4 rounded-2xl rounded-tl-none shadow-sm font-['Work_Sans'] text-[16px] text-[#191c1e]">
            {text}
          </div>
  ...
  return (
    <div className="flex flex-row-reverse gap-4 max-w-[80%] ml-auto">
      ...
      <div className="flex flex-col items-end space-y-1">
        <div className="bg-[#002045] text-white p-4 rounded-2xl rounded-tr-none shadow-md font-['Work_Sans'] text-[16px]">
          {text}
        </div>
        <span className="font-['Work_Sans'] text-[10px] text-[#74777f] px-1">{time}</span>
      </div>
